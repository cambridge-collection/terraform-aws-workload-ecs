...
| <a name="input_datasync_s3_source_bucket_name"></a> [datasync\_s3\_source\_bucket\_name](#input\_datasync\_s3\_source\_bucket\_name) | Name of an S3 bucket to use as DataSync source | `string` | `""` | no |
