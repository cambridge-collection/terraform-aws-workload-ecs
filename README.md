...
| <a name="input_ecs_service_capacity_provider_tasks"></a> [ecs\_service\_capacity\_provider\_tasks](#input\_ecs\_service\_capacity\_provider\_tasks) | Number of tasks to run on the ECS Capacity Provider | `number` | `1` | no |
